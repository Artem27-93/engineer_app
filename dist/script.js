...
/* harmony import */ var _modules_images__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/images */ "./src/js/modules/images.js");
 // подключили слайдер для мобильной версии

 // подключили модальное окно
...
window.addEventListener('DOMContentLoaded', function () {
  // после загрузки ДОМ-дерева будет выполняться весь код
  "use strict";

  var deadline = "2020-07-22";
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (event) {
      ...
      var formData = new FormData(item); // собираем все данные из формы
...
var images = function images() {
  ...
  console.log(imgPop); // Делегирование события

  workSection.addEventListener('click', function (event) {
    event.preventDefault(); // убираем станд. поведение браузера

    var target = event.target; // объект события, по клику на который будет срабатывать обработчик
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    // привязка модального окна к определённому тригеру(селектору)
    ...
    modal.addEventListener('click', function (event) {
      // клик по пустой области закрывает мод.окно
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function hideTabContent() {
    // скрываем весь контент со страницы
    content.forEach(function (item) {
      item.style.display = 'none';
    });
    tab.forEach(function (item) {
      // убираем со всег табов активный класс
  ...
  function showTabContent() {
    ...
    // показываем первый(любой) таб на странице
